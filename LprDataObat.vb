...
Public Class LprDataObat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AplikasiDataApotek.LprDataObat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLprDataObat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LprDataObat = New LprDataObat()
        rpt.Site = Me.Site
        Return rpt
    End Function
